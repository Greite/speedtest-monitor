...
/**
 * speedtest theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { speedtestTheme } from './speedtest';
 *   import './speedtest.css';
 */
export const speedtestTheme = {
  name: 'speedtest',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(oklch(1 0 0), oklch(0.19 0.008 260))",
    "--color-background-body": "light-dark(oklch(0.99 0.002 250), oklch(0.135 0.01 260))",
    "--color-background-card": "light-dark(oklch(1 0 0), oklch(0.19 0.008 260))",
    "--color-background-popover": "light-dark(oklch(1 0 0), oklch(0.19 0.008 260))",
    "--color-background-muted": "light-dark(#f1f1f1, #1b1b1b)",
    "--color-accent": "light-dark(oklch(0.56 0.19 250), oklch(0.7 0.17 240))",
